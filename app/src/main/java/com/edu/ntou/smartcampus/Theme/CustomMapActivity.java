...
import com.edu.ntou.smartcampus.CustomMap.cMapFragment;
import com.edu.ntou.smartcampus.CustomMap.cMarkFragment;
...
public class CustomMapActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new cMarkFragment(), "圖標");
        adapter.addFragment(new cMapFragment(), "地圖");
        /*adapter.addFragment(new cRouteFragment(), "路線");*/
